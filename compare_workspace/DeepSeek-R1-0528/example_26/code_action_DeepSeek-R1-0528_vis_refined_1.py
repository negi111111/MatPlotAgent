...
from mpl_toolkits.mplot3d import art3d  # Required for 3D polygon conversion
...
for i in range(len(y_values)):
    # Create polygon vertices: start at (x0, y_i, 0), then along the curve, then back to (x_end, y_i, 0)
    ...
    # Position polygon in 3D space (y-direction)
